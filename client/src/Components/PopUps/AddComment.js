    ...
    return (
        <div>
            ...
            >
                ...
                <DialogContent>
                    <div>{isButtonClicked && !isValidComment ? <Alert severity="error">You can not send empty Comment!</Alert> : ""}</div>
                    <TextField
                ...
                <DialogContent>
                    <Card className={classes.post_card}>
                        ...
                        <div className={classes.post_info}>
                            <div className={classes.post_info_left}>
                                <p className={classes.post_info_text}>{props.element.post_message}</p>
                    ...
                    {CommentsList.map((element) => (
                        <Card key={element._date} className={classes.post_card}>
                            ...
                            <div className={classes.post_info}>
                                <div className={classes.post_info_left}>
                                    <p className={classes.post_info_text}>{element.comments_list.comment_content}</p>
                                </div>
                            </div>
                        </Card>
                    ))}
